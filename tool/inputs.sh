...
echo "$DESeq2_padj $DESeq2_LFC $RRA_Score $waddR_resolution $waddR_permnum $multiXrank_r $multiXrank_selfloops $multiXrank_delta $Molti_modularity $Molti_Louvain"
