...
expression_mats  = pd.read_csv('1-Obtaining-DEGs-for-HB/Study_Variability/ANOVA_study/tmp/normalized_counts.csv', delimiter= ",")
...
# Load degs
degs = pd.read_csv('1-Obtaining-DEGs-for-HB/Study_Variability/ANOVA_study/tmp/lfc.csv', usecols = ['Unnamed: 0','log2FoldChange'], delimiter= ",").set_index(['Unnamed: 0'])
...
data.to_csv('1-Obtaining-DEGs-for-HB/Study_Variability/ANOVA_study/tmp/study_expression.csv')