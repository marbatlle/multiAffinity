...
cts_path <- "1-Obtaining-DEGs-for-HB/Study_Variability/ANOVA_study/tmp/raw_data.csv"
cts <- read.csv(cts_path, row.names=1)

## Import Metadata
meta_path <- '1-Obtaining-DEGs-for-HB/Study_Variability/ANOVA_study/tmp/metadata.csv'
...
# Extract data
write.csv(res_subset, "1-Obtaining-DEGs-for-HB/Study_Variability/ANOVA_study/tmp/lfc.csv")
...
write.table(normalized_counts, file="1-Obtaining-DEGs-for-HB/Study_Variability/ANOVA_study/tmp/normalized_counts.csv", sep=",", quote=F, col.names=NA)
