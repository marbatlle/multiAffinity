...
plot.HB = function(x, labels,
         ...
         colors=c("orange", "darkolivegreen"),
...
library(readr)
NT <- as.data.frame(read_csv("1-Obtaining-DEGs-for-HB/Study_Variability/Normalization_Comparison/NT_grein.csv", col_types = cols(Study = col_factor(levels = c("Study A", "Study B","Study C","Study D","Study E")))))
head(NT, 3)
```
...
setwd("~/Documents/TFM/GitHub/HB_PublicData")
library(readr)
T <- as.data.frame(read_csv("1-Obtaining-DEGs-for-HB/Study_Variability/Normalization_Comparison/T_grein.csv", col_types = cols(Study = col_factor(levels = c("Study A", "Study B","Study C","Study D","Study E")))))
head(T, 3)
```
