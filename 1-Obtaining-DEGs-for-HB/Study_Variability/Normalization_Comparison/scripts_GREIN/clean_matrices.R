...
## Study A
### Import Matrix
StudyA_data <- read_csv("1-Obtaining-DEGs-for-HB/Study_Variability/Normalization_Comparison/norm_matrices/norm_GREIN_GSE81928.csv")
...
## Study B
### Import Matrix
StudyB_data <- read_csv("1-Obtaining-DEGs-for-HB/Study_Variability/Normalization_Comparison/norm_matrices/norm_GREIN_GSE89775.csv")
...
## Study C
### Import Matrix
StudyC_data <- read_csv("1-Obtaining-DEGs-for-HB/Study_Variability/Normalization_Comparison/norm_matrices/norm_GREIN_GSE104766.csv")
...
## Study D
### Import Matrix
StudyD_data <- read_csv("1-Obtaining-DEGs-for-HB/Study_Variability/Normalization_Comparison/norm_matrices/norm_GREIN_GSE133039.csv")
...
## Study E
### Import Matrix
StudyE_data <- read_csv("1-Obtaining-DEGs-for-HB/Study_Variability/Normalization_Comparison/norm_matrices/norm_GREIN_GSE151347.csv")
...
write.csv(StudyA_NT,"1-Obtaining-DEGs-for-HB/Study_Variability/Normalization_Comparison/StudyA_NT.csv", row.names = FALSE)

StudyA_T <- StudyA_means['Hepatoblastoma']
StudyA_T['Study'] = 'Study A'
colnames(StudyA_T) <- c("Expression", 'Study')
write.csv(StudyA_T,"1-Obtaining-DEGs-for-HB/Study_Variability/Normalization_Comparison/StudyA_T.csv", row.names = FALSE)
...
write.csv(StudyB_NT,"1-Obtaining-DEGs-for-HB/Study_Variability/Normalization_Comparison/StudyB_NT.csv", row.names = FALSE)

StudyB_T <- StudyB_means['Hepatoblastoma']
StudyB_T['Study'] = 'Study B'
colnames(StudyB_T) <- c("Expression", 'Study')
write.csv(StudyB_T,"1-Obtaining-DEGs-for-HB/Study_Variability/Normalization_Comparison/StudyB_T.csv", row.names = FALSE)
...
write.csv(StudyC_NT,"1-Obtaining-DEGs-for-HB/Study_Variability/Normalization_Comparison/StudyC_NT.csv", row.names = FALSE)

StudyC_T <- StudyC_means['Hepatoblastoma']
StudyC_T['Study'] = 'Study C'
colnames(StudyC_T) <- c("Expression", 'Study')
write.csv(StudyC_T,"1-Obtaining-DEGs-for-HB/Study_Variability/Normalization_Comparison/StudyC_T.csv", row.names = FALSE)
...
write.csv(StudyD_NT,"1-Obtaining-DEGs-for-HB/Study_Variability/Normalization_Comparison/StudyD_NT.csv", row.names = FALSE)

StudyD_T <- StudyD_means['Hepatoblastoma']
StudyD_T['Study'] = 'Study D'
colnames(StudyD_T) <- c("Expression", 'Study')
write.csv(StudyD_T,"1-Obtaining-DEGs-for-HB/Study_Variability/Normalization_Comparison/StudyD_T.csv", row.names = FALSE)
...
write.csv(StudyE_NT,"1-Obtaining-DEGs-for-HB/Study_Variability/Normalization_Comparison/StudyE_NT.csv", row.names = FALSE)

StudyE_T <- StudyE_means['Hepatoblastoma']
StudyE_T['Study'] = 'Study E'
colnames(StudyE_T) <- c("Expression", 'Study')
write.csv(StudyE_T,"1-Obtaining-DEGs-for-HB/Study_Variability/Normalization_Comparison/StudyE_T.csv", row.names = FALSE)
