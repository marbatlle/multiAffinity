...
data.to_csv("1-Obtaining-DEGs-for-HB/Study_Variability/output/deseq.csv", index=False)
...
# Join studies
data = pd.concat([StudyA_joined, StudyB_joined], axis=0)
data.to_csv("1-Obtaining-DEGs-for-HB/Study_Variability/output/deseq_degs.csv", index=False)
