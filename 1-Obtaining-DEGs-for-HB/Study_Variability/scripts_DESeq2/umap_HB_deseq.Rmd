...
library(readr)
NT <- as.data.frame(read.csv("1-Obtaining-DEGs-for-HB/Study_Variability/output/NT_deseq.csv", stringsAsFactors=TRUE))
head(NT, 3)
```
...
setwd("~/Documents/TFM/GitHub/HB_PublicData")
library(readr)
NT <- as.data.frame(read.csv("1-Obtaining-DEGs-for-HB/Study_Variability/output/NT_deseq_DEGs.csv", stringsAsFactors=TRUE))
head(NT, 3)
```
...
setwd("~/Documents/TFM/GitHub/HB_PublicData")
library(readr)
T <- as.data.frame(read.csv("1-Obtaining-DEGs-for-HB/Study_Variability/output/T_deseq.csv", stringsAsFactors=TRUE))
head(T, 3)
```
...
setwd("~/Documents/TFM/GitHub/HB_PublicData")
library(readr)
T <- as.data.frame(read.csv("1-Obtaining-DEGs-for-HB/Study_Variability/output/T_deseq_DEGs.csv", stringsAsFactors=TRUE))
head(T, 3)
```
