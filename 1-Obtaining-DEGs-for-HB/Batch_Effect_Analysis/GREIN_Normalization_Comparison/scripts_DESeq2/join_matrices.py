...
data_NT.to_csv("1-Obtaining-DEGs-for-HB/Batch_Effect_Analysis/GREIN_Normalization_Comparison/NT_deseq.csv", index=False)

# T
data_T = pd.concat([StudyA_T, StudyB_T, StudyC_T, StudyD_T, StudyE_T], axis=0)
data_T.to_csv("1-Obtaining-DEGs-for-HB/Batch_Effect_Analysis/GREIN_Normalization_Comparison/T_deseq.csv", index=False)
