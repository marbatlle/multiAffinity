...
plot.HB = function(x, labels,
         ...
         colors=c("lightcoral", "darkolivegreen","paleturquoise","khaki","plum2"),
...
library(readr)
NT <- as.data.frame(read_csv("1-Obtaining-DEGs-for-HB/Batch_Effect_Analysis/GREIN_Normalization_Comparison/NT.csv", col_types = cols(Study = col_factor(levels = c("Study A", "Study B","Study C","Study D","Study E")))))
head(NT, 3)
```
...
setwd("~/Documents/TFM/GitHub/HB_PublicData")
library(readr)
T <- as.data.frame(read_csv("1-Obtaining-DEGs-for-HB/Batch_Effect_Analysis/GREIN_Normalization_Comparison/T.csv", col_types = cols(Study = col_factor(levels = c("Study A", "Study B","Study C","Study D","Study E")))))
head(T, 3)
```
