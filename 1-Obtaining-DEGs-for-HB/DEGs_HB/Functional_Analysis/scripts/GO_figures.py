...
up_go_path = '1-Obtaining-DEGs-for-HB/DEGs_HB/Functional_Analysis/output/upregulated_GO.txt'
...
plt.tight_layout()
plt.savefig('1-Obtaining-DEGs-for-HB/DEGs_HB/Functional_Analysis/output/upregulated_GO')

down_go_path = '1-Obtaining-DEGs-for-HB/DEGs_HB/Functional_Analysis/output/downregulated_GO.txt'
...
plt.savefig('1-Obtaining-DEGs-for-HB/DEGs_HB/Functional_Analysis/output/downregulated_GO')