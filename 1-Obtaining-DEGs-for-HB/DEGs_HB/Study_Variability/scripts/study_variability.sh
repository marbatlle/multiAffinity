...
python 1-Obtaining-DEGs-for-HB/DEGs_HB/Study_Variability/scripts/obtain_mean_exp.py
python 1-Obtaining-DEGs-for-HB/DEGs_HB/Study_Variability/scripts/join_matrices.py
mv 1-Obtaining-DEGs-for-HB/DEGs_HB/Study_Variability/tmp/study_expression.csv 1-Obtaining-DEGs-for-HB/DEGs_HB/Study_Variability/output/GSE81928_expression.csv
