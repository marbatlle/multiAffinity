...
cts_path <- "1-Obtaining-DEGs-for-HB/DEGs_HB/Study_Variability/tmp/raw_data.csv"
cts <- read.csv(cts_path, row.names=1)

## Import Metadata
meta_path <- '1-Obtaining-DEGs-for-HB/DEGs_HB/Study_Variability/tmp/metadata.csv'
