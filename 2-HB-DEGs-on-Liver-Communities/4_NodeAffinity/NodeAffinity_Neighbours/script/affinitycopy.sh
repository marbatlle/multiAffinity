...
do
    ...
    for genes in $(ls 2-HB-DEGs-on-Liver-Communities/4_NodeAffinity/NodeAffinity_Neighbourss/output/PTmatrix_${id}_*.txt | sed "s:2-HB-DEGs-on-Liver-Communities/4_NodeAffinity/NodeAffinity_Neighbours/output/PTmatrix_${id}_::" | cut -d"." -f1)
    do
        cp 2-HB-DEGs-on-Liver-Communities/4_NodeAffinity/NodeAffinity_Neighboursoutput/PTmatrix_${id}_${genes}.txt 2-HB-DEGs-on-Liver-Communities/4_NodeAffinity/NodeAffinity_Neighbours/PTmatrix_tmp_PPI.txt
