...
path_to_files = '2-HB-DEGs-on-Liver-Communities/4_NodeAffinity/output/neighbours/temp/'
lst_corr = []
...
corr_joined.to_csv(r'2-HB-DEGs-on-Liver-Communities/4_NodeAffinity/output/neighbours/temp/corr.txt', sep='\t',index = False)