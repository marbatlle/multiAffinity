...
outfile_path = '2-HB-DEGs-on-Liver-Communities/1_Networks/2_Metabolic_Network/src/Recon3D.xml'
...
file = '2-HB-DEGs-on-Liver-Communities/1_Networks/2_Metabolic_Network/src/metabolites_to_prune.txt'
...
nx.write_edgelist(G,"2-HB-DEGs-on-Liver-Communities/1_Networks/2_Metabolic_Network/networks/Recon3D_metabolites."+now.strftime("%d-%m-%Y")+".gr",data=['label'])
