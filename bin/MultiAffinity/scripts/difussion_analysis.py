...
path_to_files = 'MultiAffinity/src/metaDEGs/normalized_counts/'
lst_expmat = []
...
#Load degs
degs_path = 'MultiAffinity/src/metaDEGs/metaDEGs/metaDEGs.txt'
degs = pd.read_csv(degs_path, index_col=0)
degs_names = degs.index.tolist()

#Load rwr matrix
mat_path = 'MultiAffinity/output/dRWR_matrix.txt'
